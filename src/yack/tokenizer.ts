                ...
                if (/[a-z]/.test(c)) {
                    ...
                    if (ident != null) {
                        ...
                        if (code.charAt(column + ident.length) === ':') {
                            ...
                            column += ident.length;
                            break;
                        } else if (symbol === 'if' || symbol === 'elif' || symbol === 'else' || symbol === 'endif') {
                            tokens.push({
                                type: 'control_flow',
                                keyword: symbol,
                                line,
...
function tryParseCondition(code: string): {expr: string, length: number} | null {
...
function tryParseIdentifier(code: string): {ident: string, length: number} | null {
